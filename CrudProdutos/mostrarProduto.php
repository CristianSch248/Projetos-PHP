            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="mostrarProduto.php">Mostrar Estoque de Peças</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            while($resultadoSeparado = mysqli_fetch_assoc($resultado)){
                                echo"
                                    <tr>
                                        ...
                                        <td>$resultadoSeparado[fabricante]</td>
                                        <td>$resultadoSeparado[quantidade]</td>
                                        <td><a class='btn btn-primary' href='editarProduto.php?codigo=$resultadoSeparado[codigo]'>Editar</td>
                                    </tr>
                                ";
                            }
                        }
