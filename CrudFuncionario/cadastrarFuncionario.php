      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Cadastrar Funcionarios</a>
            </li>
          </div>
        </div>
      </nav>
    ...
    <div class="container">
      <form method="post" action="controleFuncionario.php">
        ...
        <div class="mb-3">
         ...
         <input type="text" class="form-control" id="nome" name="nome" placeholder="digite o nome do(a) funcionario(a)">
        </div>
        <div class="mb-3">
          <label for="cpf" class="form-label">CPF:</label>
          <input type="text" class="form-control" id="cpf" name="cpf" aria-describedby="cpfHelp">
          <div id="cpfHelp" class="form-text">
            Formato do cpf 999.999.999-99
          </div>
        </div>
