...
<head>
  ...
  <title>Agricultor | Cadastrar</title>
</head>
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="cadastrarAgricultor.php">Cadastrar</a>
        </li>
        <li class="nav-item">
...
<div class="container">
  <form method="post" action="controleAgricultor.php">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome do(a) agricultor(a)">
    </div>
    <div class="mb-3">
