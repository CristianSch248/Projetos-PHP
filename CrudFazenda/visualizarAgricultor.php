...
<head>
  ...
  <title>Agricultor | Visualizar</title>
</head>
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="visualizarAgricultor.php">Visualizar</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container">
  <form>
    <h3>Visualizar - Pesquisar</h3>
    <div class="mb-3">
      <label for="pesquisa" class="form-label">Pesquisa:</label>
      <input type="text" class="form-control" id="pesquisa" name="pesquisa" placeholder="Para a pesquisa, informe:Nome ou CPF">
    </div>
...
<script src="javascrptPesquisar.js" Type="text/JavaScript"></script>
